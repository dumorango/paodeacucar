...
import br.com.companhiadesistemas.itimcustomreports.entities.ReportTelefoniaService;

import com.googlecode.jsonrpc4j.JsonRpcServer;

public class ReportTelefoniaServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) {
       		this.jsonRpcServer = new JsonRpcServer(new ReportTelefoniaService(),ReportService.class);
        }
