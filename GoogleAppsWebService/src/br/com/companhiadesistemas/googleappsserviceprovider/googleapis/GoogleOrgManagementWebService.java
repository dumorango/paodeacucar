...
* 
*/
public class GoogleOrgManagementWebService extends GoogleWebService{

 public enum OrgUnitProperty {
   NAME, DESCRIPTION, PARENT_ORG_UNIT_PATH, BLOCK_INHERTANCE, USERS_TO_MOVE
 }

 AppsPropertyService googleservice;
  ...
  */
 public GoogleOrgManagementWebService(String domain) throws AuthenticationException {
	 super(domain);
...
/**
 ...
 public GenericEntry retrieveCustomerId(String domain) throws AppsForYourDomainException,
   ...
   GenericEntry entry =
       googleservice.getEntry(new URL("https://apps-apis.google.com/a/feeds/customer/2.0/customerId"),
           GenericEntry.class);
   return entry;
 }
 ...
 public GenericEntry createOrganizationUnit(String customerId, String orgUnitName,
   ...
   entry =
       googleservice.insert(new URL("https://apps-apis.google.com/a/feeds/orgunit/2.0/" + customerId),
           entry);
   return entry;
 }
 ...
 public GenericEntry retrieveOrganizationUnit(String customerId, String orgUnitPath)
     throws AppsForYourDomainException, MalformedURLException, IOException, ServiceException {
   GenericEntry entry =
       googleservice.getEntry(new URL("https://apps-apis.google.com/a/feeds/orgunit/2.0/" + customerId
 ...
 public void deleteOrganizationUnit(String customerId, String orgUnitPath)
     throws AppsForYourDomainException, MalformedURLException, IOException, ServiceException {
   googleservice.delete(new URL("https://apps-apis.google.com/a/feeds/orgunit/2.0/" + customerId + "/"
       + orgUnitPath));
 }
 ...
 public GenericEntry updateOrganizationUnit(String customerId, String orgUnitPath,
   ...
   return googleservice.update(new URL("https://apps-apis.google.com/a/feeds/orgunit/2.0/" + customerId
       + "/" + orgUnitPath), entry);
 }
  ...
  * @param newOrgUnit the new organization unit path.
 ...
 public GenericEntry updateOrganizationUser(String customerId, String orgUserEmail,
     String oldOrgUnitPath, GenericEntry newOrgUnit) throws AppsForYourDomainException,
     MalformedURLException, IOException, ServiceException {
   GenericEntry entry = new GenericEntry();
   if (oldOrgUnitPath != null && oldOrgUnitPath.length() != 0) {
     entry.addProperty("oldOrgUnitPath", oldOrgUnitPath);
   }
   if(newOrgUnit.getProperty("orgUnitPath")!=null){
	   //entry.addProperty("orgUnitPath", newOrgUnitPath);
	   return googleservice.update(new URL("https://apps-apis.google.com/a/feeds/orguser/2.0/" + customerId
       + "/" + orgUserEmail), newOrgUnit);
   }
 ...
 public GenericEntry retrieveOrganizaionUser(String customerId, String orgUserEmail)
     throws AppsForYourDomainException, MalformedURLException, IOException, ServiceException {
   return googleservice.getEntry(new URL("https://apps-apis.google.com/a/feeds/orguser/2.0/"
 ...
 public GenericFeed retrieveFirstPageOfOrganizationUsers(String customerId)
     throws AppsForYourDomainException, MalformedURLException, IOException, ServiceException {
   return googleservice.getFeed(new URL("https://apps-apis.google.com/a/feeds/orguser/2.0/" + customerId
